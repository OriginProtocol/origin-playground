...
/**
 * Add to contract implementing ClaimVerifier:
 *
 *   if (address(verifier) != 0x0) {
 *     require(
 *       claimIsValid(verifier, ClaimHolder(msg.sender), claimType)
 *     );
 *   }
 *
 */
...
contract ClaimVerifier {
  ...
  function claimIsValid(ClaimHolder _trusted, ClaimHolder _identity, uint256 claimType)
    public
    constant
    returns (bool claimValid)
  {
    ...
    bytes32 claimId = keccak256(_trusted, claimType);
    ...
    return _trusted.keyHasPurpose(hashedAddr, 3);
  }
